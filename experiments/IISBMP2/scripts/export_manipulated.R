...
BMP.comparison <- BMP.all[, c('descrip', 'mean.vol', 'sd.vol', 'mean.grav', 'sd.grav', 'mean.gd', 'sd.gd')]
write.csv(BMP.comparison, '../results/BMP.csv', row.names = FALSE)

yld.comparison <- yld.all[, c('descrip', 'elapsed.time', 'mean.vol', 'sd.vol', 'mean.grav', 'sd.grav', 'mean.gd', 'sd.gd')]
write.csv(yld.comparison, '../results/yld.csv', row.names = FALSE)

BMPo.comparison <- BMPo.all[, c('id', 'cvCH4.vol', 'cvCH4.grav', 'cvCH4.gd')]
